				...
				<div class="wrapper-header">
					<div class="wrapper-logo">
						<?php if (is_front_page()) { ?>
							<h1 class="h1-hide">Deli Kitchen</h1>
							<picture>
								<source media="(max-width:680px)" srcset="<?php echo get_stylesheet_directory_uri(); ?>/src/images/deli-kitchen-logo-small.png">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/src/images/deli-kitchen-logo.png" alt="logo Deli Kitchen">
							</picture>
						<?php } else { ?>
							<a href="<?php echo esc_url(home_url()); ?>" title="logo Deli Kitchen">
								<picture>
